...
var LastTimeComponent = /** @class */ (function () {
    ...
    LastTimeComponent.prototype.reloadItems = function (includeArchived) {
        var _this = this;
...
var TasksComponent = /** @class */ (function () {
    ...
    TasksComponent.prototype.calculateIndicators = function () {
        ...
        addIndicator("Open Count EOD", calculateForAllDays(days, this.services.taskIndicator.totalTaskCountUntil), null, function (prev, curr) { return ({
            isCompleted: prev >= curr,
            percentageCompleted: prev !== 0 ? Math.round((curr * 100) / prev) / 100 : 0
        }); });
        // added ETA
        addIndicator("Added ETA", calculateForAllDays(days, this.services.taskIndicator.addedETA), function (v) { return _this.formatTime(v * 60); }, function (prev, curr) { return ({
            isCompleted: prev >= curr,
            percentageCompleted: prev !== 0 ? Math.round((curr * 100) / prev) / 100 : 0
        }); });
        // added count
        addIndicator("Added Count", calculateForAllDays(days, this.services.taskIndicator.addedTaskCount), null, function (prev, curr) { return ({
            isCompleted: prev >= curr,
            percentageCompleted: prev !== 0 ? Math.round((curr * 100) / prev) / 100 : 0
        }); });
        // closed ETA
        ...
        addIndicator("Closed Spent", calculateForAllDays(days, function (d1, d2) {
            return _this.services.taskIndicator.calculateTotalTimeSpent(d1, d2)
                .totalTimeSpentTodayOnClosedTasks;
        }), function (v) { return _this.formatTime(v); });
        // closed count
        ...
        // Open ETA
        addIndicator("Open ETA", calculateForAllDays(days, this.services.taskIndicator.openETA), function (v) { return _this.formatTime(v * 60); }, function (prev, curr) { return ({
            isCompleted: prev >= curr,
            percentageCompleted: prev !== 0 ? Math.round((curr * 100) / prev) / 100 : 0
        }); });
        // Spent on Open Tasks
