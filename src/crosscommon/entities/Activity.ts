...
export class Activity implements iEntity {
	...
	constructor(base?: any){
		if (base !== undefined){
			...
			this.act_tasks_tag = base.act_tasks_tag;
			this.act_close_comment = base.act_close_comment;
			this.act_id_user = base.act_id_user;
			this.act_date_add = (base.act_date_add !== null) ? new Date(base.act_date_add) : null;
			this.act_date_mod = (base.act_date_mod !== null) ? new Date(base.act_date_mod) : null;
